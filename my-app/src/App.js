...
function NewTask(props){
  ...
  function chatGPT() {
    ...
    const configuration = new Configuration({
      ...
      apiKey: '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',
    });
    ...
    /*
    const apiKey = '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';
    ...
    fetch(apiUrl, requestOptions)
      ...
      .catch(error => {
        console.error('There was a problem with the Chat GPT API request:', error);
      });
      */
  ...
  return (
    <tr className = "border">
      ...
      <td className="text-end" colSpan = "2">
        ...
        <button type="button" className="btn btn-default btn-success" alt="Chat GPT" onClick = {chatGPT}>
          <i className="bi bi-plus-square"></i> Chat GPT
        </button>
      </td>
    </tr>
  );
